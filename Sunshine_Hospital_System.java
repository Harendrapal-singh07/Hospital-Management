...
public class Sunshine_Hospital_System extends JFrame
{
    ...
    public Sunshine_Hospital_System()
    {
        setTitle("🌟Sunshine Hospital: Comprehensive Hospital Management System🌟");
        setSize(1280, 720);
        ...
        mainPanel.setBackground(new Color(24, 23, 23));

        // Title label
        JLabel titleLabel = new JLabel("🏥 Sunshine-Hospital: Comprehensive Healthcare 🏥", SwingConstants.CENTER);
    ...
    {
        SwingUtilities.invokeLater(Sunshine_Hospital_System::new);
    }
}